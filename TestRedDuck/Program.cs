...
namespace TestRedDuck
{
    ...
    class Program
    {
        ...
        //private static string gSymbol = "";

        //private static IWebSocket trades = null;

        //private static int botMsgTradesId = 0;
        //private static int botMsgCandlesId = 0;
        //private static Timer t = new Timer();

        static void Main(string[] args)
        {

            TGBot TestBot = new TGBot();
        ...
        //private static async void Bot_OnMessage(object sender, MessageEventArgs e) // Обработка сообщений
        //{
        ...
        //private static async void showTrades(string exchange, string gSymbol, long chatId) // Вывод трейдов
        //{
        ...
        //private static async void showCandles(string exchange, string gSymbol, long chatId) // Вывод свечей
        //{
        ...
        //        t.Elapsed += new ElapsedEventHandler(async (sender, e) =>
        //        {
